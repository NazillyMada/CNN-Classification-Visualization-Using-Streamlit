...
@st.cache(allow_output_mutation=True,suppress_st_warning=True)
def load_cnn2():
    model_ = load_model('D:/Bootcamp ML - Mada/FINAL PROJECT/weights3.h5')
    return model_
...
def main():
 ...
 github.com/NazillyMada""")
    ...
    if choice == 1 :
        ...
        sample1 = Image.open('C:/Users/0974/Pictures/final project/Capture.png')
        st.image(sample1,caption='Parasitized Cells', use_column_width=True)
        sample2 = Image.open('C:/Users/0974/Pictures/final project/Capture1.png')
